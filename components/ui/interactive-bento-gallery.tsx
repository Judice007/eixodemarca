...
interface InteractiveBentoGalleryProps {
    ...
    title: string
    description: string
    /** Sobrescreve o container: o padrão é estreito (max-w-4xl) demais pras seções largas do site. */
    containerClassName?: string
    /** Sobrescreve a grade: permite células no formato reels em vez do bento padrão. */
...
const InteractiveBentoGallery: React.FC<InteractiveBentoGalleryProps> = ({
    ...
    gridClassName = 'grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 auto-rows-[60px]',
}) => {
